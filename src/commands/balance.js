...
export async function execute(interaction) {
  try {
    ...
    const embed = new EmbedBuilder()
      ...
      .addFields(
        { name: 'Cash', value: `₹${bal.cashBalance.toFixed(2)}`, inline: true },
        { name: 'Card', value: `₹${bal.cardBalance.toFixed(2)}`, inline: true },
        { name: 'Total', value: `₹${bal.total.toFixed(2)}`, inline: true },
      )
      .setTimestamp();
